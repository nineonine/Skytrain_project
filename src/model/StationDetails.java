...
public class StationDetails {
	...
	public StationDetails() {
		...
		desc[6] = "Broadway-City Hall Station is a station on the SkyTrain's Canada Line in Vancouver, British Columbia, Canada. This station has a large doubleheight ceiling over the platform area.";
		...
		desc[46] = "YVR-Airport Station is one of the two southern intermodal termini on the SkyTrain's Canada Line in Richmond, British Columbia, Canada. The railway station serves both the domestic and international terminals of Vancouver International Airport (YVR), and provides the first direct, transferfree public transit connection between Downtown Vancouver and the airport.";
		...
		loc[29] = "The station is located at the northeastern fringe of Burnaby's Central Park, at the corner of Patterson Avenue and Central Boulevard. A stretch of the SkyTrain line west of the station actually crosses through the park.\n\n"
				+ "This station is located above the old right-of-way of the nowdefunct British Columbia Electric Railway Central Park Line; this line ran from just west of Nanaimo Station all the way to where the current New Westminster Station is located.";
