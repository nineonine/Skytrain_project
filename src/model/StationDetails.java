...
public class StationDetails {
	...
	public StationDetails() {
		...
		desc[11] = "Gateway Station is a station on an elevated portion of the Expo Line, a part of Vancouver, British Columbia's SkyTrain rapid transit system.";
		...
		loc[27] = "The station entrance is located on the southwest corner of the intersection, adjacent to the entrance to Oakridge Centre. It serves the Oakridge area, consisting of a residential neighbourhood, street-side stores along Cambie Street, and the Oakridge Centre complex, and is within walking distance of Queen Elizabeth Park. The station is located 6 metres underground.";
		...
		loc[29] = "The station is located at the northeastern fringe of Burnaby's Central Park, at the corner of Patterson Avenue and Central Boulevard. A stretch of the SkyTrain line west of the station actually crosses through the park.\n\n"
				+ "This station is located above the old right-of-way of the now-defunct British Columbia Electric Railway Central Park Line; this line ran from just west of Nanaimo Station all the way to where the current New Westminster Station is located.";
